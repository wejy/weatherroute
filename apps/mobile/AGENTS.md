...
This app is part of WeatherTrip. Root rules in `/AGENTS.md` and `.cursor/rules/dual-platform-i18n.mdc` always apply:
...
- Import copy from `@weathertrip/i18n` — do not hardcode UI strings.
