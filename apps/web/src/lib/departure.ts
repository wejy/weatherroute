/** Hours of day (0–23) for per-route departure window (Pro). */
...
/** @deprecated Prefer parseDepartureHourParam */
export const parseEarliestHourParam = parseDepartureHourParam;
